...
- When the final answer is written in Chinese, also include an English translation in the same turn, formatted line-by-line so each Chinese line is followed immediately by its English translation.
